...
- Started the productization phase for the SSMS demo: toolbar buttons, menu
...
| P1 | Productized demo depth | The demo controls are now wired, but it still uses sample data and visual-only execution. | Keep real data work inside SSMS DEV; add backend-backed demo behavior only after the SSMS contract is stable. |
