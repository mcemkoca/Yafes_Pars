...
--
-- Migrations 043 (import staging) and 044 (claim settlement) were implemented
-- before the SchemaMigration tracking pattern was established.  They create
-- their objects idempotently (IF NOT EXISTS) but never recorded their own
-- completion marker.  This migration back-fills those rows so the tracking
-- table accurately reflects which migrations have been applied.
-- =============================================================================
USE [YafesPars];
GO
...
BEGIN TRY
    ...
    BEGIN
        ...
        PRINT 'Migration 047: SchemaMigration entries added for 043 and 044.';
    END
