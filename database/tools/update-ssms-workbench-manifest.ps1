...
$domainMetadata = [ordered]@{
    ...
    communication = [ordered]@{ order = 140; lane = "Operations"; title = "Communication"; subheading = "Transactionele e-maillog, compliance-trail voor alle berichten"; entryPoint = "06__query_library_shortcuts.sql" }
}
